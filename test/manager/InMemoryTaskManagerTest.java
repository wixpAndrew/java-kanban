...
public class InMemoryTaskManagerTest extends TaskManagerTest<InMemoryTaskManager> {
    ...
    void testIsItRightWorkingTasks() {
        ...
        assertEquals(this.manager.isHereCrossing(), false);

        Task task4 = new Task("Tsf", Progress.DONE, "dfd");
        task4.setStartTime(LocalDateTime.of(2024, 12, 19, 11, 0));
        task4.setEndTime(LocalDateTime.of(2024, 12, 19, 14, 0));
        this.manager.addTask(task4);
        assertEquals(this.manager.isHereCrossing(), true);
    }
}